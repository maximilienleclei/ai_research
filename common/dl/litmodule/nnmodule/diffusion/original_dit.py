"""Imported (unmodified) from https://github.com/facebookresearch/DiT/blob/main/models.py."""
...
def modulate(x, shift, scale):
    """."""  # Only modification in the code to have the function show up in the documentation.
