...
import numpy as np
from common.ne.agent import BaseAgent
from common.ne.space import BaseSpace
from common.ne.utils.compute import (
    compute_generation_results, compute_save_points,
    compute_start_time_and_seeds,
    compute_total_num_env_steps_and_process_fitnesses)
from common.ne.utils.evolve import evaluate_on_cpu, evaluate_on_gpu, mutate
from common.ne.utils.exchange import (exchange_agents,
                                     update_exchange_and_mutate_info)
from common.ne.utils.initialize import (initialize_agents,
                                       initialize_common_variables,
                                       initialize_gpu_comm)
from common.ne.utils.readwrite import (find_existing_save_points, load_state,
                                      save_state)
from common.ne.utils.type import Generation_results_type
from common.ne.utils.validate import validate_space
from common.ne.utils.wandb import setup_wandb, terminate_wandb
from utils.misc import seed_all
from utils.mpi4py import get_mpi_variables

from .config import (NeuroevolutionSubtaskConfig,
...
def evolve(
    ...
    for curr_gen in range(prev_num_gens + 1, config.total_num_gens + 1):
        ...
        if curr_gen == 1:
            # See https://github.com/maximilienleclei/ai_research/blob/main/docs/genetic.pdf
