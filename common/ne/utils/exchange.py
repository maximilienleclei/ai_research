...
from common.ne.utils.type import (Exchange_and_mutate_info_batch_type,
                                 Exchange_and_mutate_info_type,
                                 Generation_results_type, Seeds_type)
from utils.beartype import ge, le
...
def update_exchange_and_mutate_info(
    ...
    :mod:`ai_research`. We make use of 50% truncation selection, which is
